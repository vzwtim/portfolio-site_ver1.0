...
export default function InterestsSection() {
  ...
  const renderDigitalGrid = (items: typeof interests.digital) => {
    ...
    const layout: { key: string; className: string; interest?: typeof items[number] }[] = [
      ...
      { key: 'ph4', className: 'relative overflow-hidden col-start-11 col-span-2 row-start-12 row-span-3' },
      ...
      { key: 'ph7', className: 'relative overflow-hidden col-start-9 col-span-2 row-start-12 row-span-4' },
      { key: 'ph8', className: 'relative overflow-hidden col-start-12 col-span-1 row-start-6 row-span-3' },
      ...
      { key: 'ph26', className: 'relative overflow-hidden col-start-12 col-span-1 row-start-11 row-span-1' },
      { key: 'ph27', className: 'relative overflow-hidden col-start-11 col-span-2 row-start-14 row-span-1' },
    ];
